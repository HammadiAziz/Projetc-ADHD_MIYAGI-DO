...
consultation::consultation(QString ID_cons,QString temps_cons,QString salle_cons,QString diag_cons,QString id_medecin,QString id_medica, QString id_enfant){
...
void consultation::setsallecons(int salle_cons){this->Salle_cons=salle_cons;}
...
QSqlQueryModel * consultation ::afficher_cons(){
    ...
    model->setHeaderData(4, Qt::Horizontal, QObject::tr("ID_MEDECIN"));
    model->setHeaderData(5, Qt::Horizontal, QObject::tr("ID_ENFANT"));
